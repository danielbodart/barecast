...
# Check for zerocast updates from GitHub Releases.
# Called by zerocast-update.timer (daily).
# Downloads and stages new versions; does NOT apply them.
# The update is applied on next service restart via zerocast-apply-update.sh.

REPO="danielbodart/zerocast"
ASSET="zerocast-linux-x86_64.tar.gz"
