...
# Roll back to the previous zerocast version.
# Triggered by OnFailure= when zerocast.service crashes repeatedly after an update.
...
main() {
    ...
    echo "Run: systemctl --user reset-failed zerocast.service && systemctl --user start zerocast.service"
}
